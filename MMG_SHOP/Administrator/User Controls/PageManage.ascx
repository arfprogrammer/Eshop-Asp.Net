<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageManage.ascx.cs"
    Inherits="Administrator_User_Controls_MainMenu" %>
    <%@ Register Assembly="FredCK.FCKeditorV2" Namespace="FredCK.FCKeditorV2" TagPrefix="FCKeditorV2" %>
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
<ContentTemplate>
<span class="SpanHelp">در این قسمت برای مدیریت صفحات میتوانید اقدام نمایید .
    </span>
<div class="DivFormTextBoxRight">
    ...
    <asp:TextBox Height="50" TextMode="MultiLine" ID="TextBox2" CssClass="TextBoxNormalLeft"
        runat="server"></asp:TextBox>
        <span class="SpanNormal" style="margin-top:20px;">محل نمایش</span>
    <asp:DropDownList  ID="DropDownList1" AutoPostBack=true  style="margin-top:20px;" CssClass="TextBoxNormal"
        runat="server" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
        <asp:ListItem Text="سمت راست صفحه" Value="Right"></asp:ListItem>
        <asp:ListItem Text="پایین صفحه" Value="Down"></asp:ListItem>
        </asp:DropDownList>
            <br />
       <span class="SpanNormal" style="margin-top:10px;">نمايش فعال گردد</span>
...
<asp:GridView ID="GridView1" style="margin-top:20px;" runat="server" AllowPaging="True" AutoGenerateColumns="False"
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="تعداد بازدید" HeaderStyle-HorizontalAlign=Center>
            <ItemTemplate>
               
                    <asp:Label ID="Label3d2" runat="server" Text='<%# Eval("Page_view") %>'></asp:Label>
              
            </ItemTemplate>
            <ItemStyle  HorizontalAlign=Center />
        </asp:TemplateField>
         <asp:TemplateField HeaderText="محل نمایش" HeaderStyle-HorizontalAlign=Center>
            <ItemTemplate>
               
                    <asp:Label ID="Labelsa3d2" runat="server" Text='<%# Eval("Place").ToString().Replace("Right","سمت راست صفحه").Replace("Down","پایین صفحه") %>'></asp:Label>

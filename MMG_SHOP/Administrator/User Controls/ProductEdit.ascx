<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ProductEdit.ascx.cs"
    Inherits="Administrator_User_Controls_MainMenu" %>
<%@ Register Assembly="FredCK.FCKeditorV2" Namespace="FredCK.FCKeditorV2" TagPrefix="FCKeditorV2" %>
<span class="SpanHelp">در این قسمت میتوانید محصولی را ویرایش نمایید : </span>
<div class="DivFormTextBoxRight">
    ...
    <asp:Image ID="Image1" style="float:right;width:300px;height:200px;margin-bottom:20px;margin-top:20px;margin-right:30px;" runat="server" />

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UserEdit.ascx.cs" Inherits="Administrator_User_Controls_MainMenu" %>
<div class="TopBig">
...
<div class="DownBig">
    ...
    <div class="SepratorBig" style=" margin-bottom: 20px; margin-top: 20px;">
        <asp:Button ID="Button1" runat="server" Text="ویرایش" Style="float: right; margin-right: 200px;"

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ProductMoxShop.ascx.cs"
    Inherits="Administrator_User_Controls_MainMenu" %>
<div class="TopSmall">
    <asp:Image ID="Image1" CssClass="ImageHeaderBox" runat="server" ImageUrl="~/Administrator/files/Design/award_star_gold_2.png" />
    <span class="SpanHeaderBox">محصولات پر فروش</span>
</div>
<div class="DownSmall">
        ...
        <Columns>
            <asp:TemplateField>
               ...
               <div style="float: right; width: 105px;margin-top:3px;">
                        ...
                        <asp:Label ID="Label1" runat="server" CssClass="BasketShopSmallRowPriceTitle" Text="فروش:"></asp:Label>
                        <asp:Label ID="Label2" CssClass="BasketShopSmallRowPrice" runat="server" Text='<%# Eval("number_shop").ToString() + " بار" %>'></asp:Label>
                    </div>
                    <div style="float: right; width: 50px;">
                        <asp:Image ID="Image1" runat="server" CssClass="BasketShopSmallRowPic" AlternateText='<%# Eval("title") %>' ImageUrl='<%#  "~/SmartPicture.aspx?f=" + Eval("Pic")  + "&w=50"  %>' />
                    </div>
